...
def generate_launch_description():
    ...
    # TODO: Need to include rviz launch file from lidarbot_description package
    # TODO: include package to get urdf file
    # TODO: remove gazebo_params.yaml file and see if it still works
